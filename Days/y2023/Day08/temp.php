    ...
    'RVK = (DRP, VMF)',
       ...
       $instructions = str_split(array_shift($input));
        ...
        for ($i = 0; $i < count($input); $i++) {
            ...
            if(str_ends_with($matches[0][0], 'A') && !isset($total)){
                $goto[] = $matches[0][0];
            }
        }
        $total ??= 0;
        ...
        while(true){
            ...
            $count++;
            if($count === 30000){
                file_put_contents('Data.txt', json_encode([$total, $goto]));
                header('Refresh:1');
                break;
            }
        }
var_dump([number_format($total , 0, ',', '.'), $goto]);